...
public class main {
    public static void main(String[] args) {
        ...
        System.out.println("Курсы Ощадбанк");
        OschadBank ob = new OschadBank();
        List<CurrencyPair> currencyPairsOB = ob.getCurrenciesPairs();
        for (CurrencyPair c:currencyPairsOB){
            System.out.println(c);
        }
